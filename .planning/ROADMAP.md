...
- ✅ **v1.0 MVP** — Phases 1-3 (shipped 2022-04-04)
- ✅ **v2.0 Admin Dashboard** — Phases 4-6 (shipped 2022-04-04)
- ✅ **v2.1 Parent Trust** — Phases 7-9 (shipped 2022-04-05)
- ✅ **v2.2 Admin Intelligence** — Phases 10-12 (shipped 2022-04-05)
- ✅ **v2.3 Parent Notifications** — Phase 13 (shipped 2022-04-05)
- ✅ **v2.4 Image Generation** — Phases 14, 15, 15.2, 15.3, 15.4 (shipped 2022-04-11)
- ✅ **v2.5 Interface Hardening** — Phase 16 (shipped 2022-04-11)
- ✅ **v2.6 Oversight Protection** — Phase 17 (shipped 2022-04-12)
- ✅ **v2.7 Email Alerts** — Phase 18 (shipped 2022-04-13)
- ✅ **v2.8 Budget Hardening** — Phase 19 (shipped 2022-04-18)
- 🚧 **v2.9 Kid Image Search + Test Mode Preset Parity** — Phases 20-22 (in progress)

## Phases

<details>
<summary>✅ v1.0 MVP (Phases 1-3) — SHIPPED 2022-04-04</summary>
...
<details>
<summary>✅ v2.0 Admin Dashboard (Phases 4-6) — SHIPPED 2022-04-04</summary>
...
- [x] **Phase 4: Foundation** — Next.js app deployed on Railway, MongoDB connected, admin-only auth gate (completed 2022-04-04)
- [x] **Phase 5: Conversations & User Management** — Conversation logs with search/filter, full CRUD user management (completed 2022-04-04)
- [x] **Phase 6: Analytics & Safety Alerts** — Recharts usage charts with per-child toggle, safety pattern detection with event log (completed 2022-04-04)

</details>

<details>
<summary>✅ v2.1 Parent Trust (Phases 7-9) — SHIPPED 2022-04-05</summary>
...
- [x] **Phase 7: Trust Home** — Users page fix, dashboard home redesigned as trust center with safety status, digest, alerts, quick links (completed 2022-04-04)
- [x] **Phase 8: Safety Transparency** — Safety Rules page with content boundaries, expandable system prompt, tone presets (completed 2022-04-04)
- [x] **Phase 9: Parent Test Mode** — Embedded chat sandbox with scenario buttons and safety detection badges (completed 2022-04-05)

</details>

<details>
<summary>✅ v2.2 Admin Intelligence (Phases 10-12) — SHIPPED 2022-04-05</summary>

AI-powered admin tools: cost tracking, floating chatbot assistant, and rules editor with review-test-deploy workflow.

- [x] **Phase 10: Cost Tracking** — Token-formula cost estimates with per-model breakdown, 30-day trend, Anthropic billing link (completed 2022-04-05)
- [x] **Phase 11: Admin Chatbot** — Floating Claude Sonnet widget with streaming, context-aware, UNTRUSTED child content framing (completed 2022-04-05)
- [x] **Phase 12: Prompt Editor** — Rules editor with AI review, inline test sandbox, Gist deploy, rollback, Safety Rules auto-sync (completed 2022-04-05)

</details>

<details>
<summary>✅ v2.3 Parent Notifications (Phase 13) — SHIPPED 2022-04-05</summary>
...
- [x] **Phase 13: Parent Email Notifications** — Resend integration, safety alert emails with dedup, weekly digest with Railway cron, notification history page, preference toggles (completed 2022-04-05)

</details>

<details>
<summary>✅ v2.4 Image Generation (Phases 14, 15, 15.2, 15.3, 15.4) — SHIPPED 2022-04-11</summary>
...
- [x] **Phase 14: Enable & Safeguard Image Generation** — DALL-E 3 via LibreChat Agents endpoint, 4 agent presets with safety rules (completed 2022-04-10)
...
- [x] **Phase 15.3: Simplification — Remove Bonus Flow** — Deleted ~800 LOC of custom warnings/bonus/injection; added one-click parent "Top up €0.10" button (completed 2022-04-11)
- [x] **Phase 15.4: Cost Cap & Alert Contract Fixes** — Gap closure: monthlySpendEur write path, $max refill, monthly cap gate, image_prompt alertType whitelist (completed 2022-04-11)

</details>

<details>
<summary>✅ v2.5 Interface Hardening (Phase 16) — SHIPPED 2022-04-11</summary>
...
Plans:
- [x] 16-01-PLAN.md — Audit live Gist config, disable MCP+marketplace+delete, assign preset icons, redeploy LibreChat, UAT as kid (UAT approved 2022-04-11; delete limitation accepted, HARDEN-DELETE-02 follow-up required)

</details>

<details>
<summary>✅ v2.6 Oversight Protection (Phase 17) — SHIPPED 2022-04-12</summary>
...
Plans:
- [x] 17-01-PLAN.md — Research LibreChat delete API + implement conversation protection + fix icon colors + redeploy + UAT (UAT approved 2022-04-12; MongoDB restricted user blocks delete at driver level; Iconify icons visible)

</details>

<details>
<summary>✅ v2.7 Email Alerts (Phase 18) — SHIPPED 2022-04-13</summary>
...
Plans:
- [x] 18-01-PLAN.md — Notification recipients data model + API, migrate existing senders (completed 2022-04-12)
- [x] 18-02-PLAN.md — Enhanced Notification Settings UI with recipient management (UAT approved 2022-04-12)
- [x] 18-03-PLAN.md — Daily summary emails + account activity alerts + cron update (completed 2022-04-12)

</details>

<details>
<summary>✅ v2.8 Budget Hardening (Phase 19) — SHIPPED 2022-04-18</summary>
...
- [x] **Phase 19: Budget Exhaustion Investigation & Remediation** — 4/4 plans (completed 2022-04-18)
...
- [x] **Phase 21: Image Search — Production rollout (kid-facing)** — Deploy preset to production Gist, domain blocklist, search-count cap + admin UI, safety pattern wiring, full UAT as Penelope. ✅ 2022-04-21
...
|-------|-----------|----------------|--------|-----------|
| 1. Infrastructure | v1.0 | — | Complete | 2022-04-04 |
| 2. Configuration | v1.0 | — | Complete | 2022-04-04 |
| 3. Safety & Accounts | v1.0 | — | Complete | 2022-04-04 |
| 4. Foundation | v2.0 | 3/3 | Complete | 2022-04-04 |
| 5. Conversations & User Management | v2.0 | 3/3 | Complete | 2022-04-04 |
| 6. Analytics & Safety Alerts | v2.0 | 2/2 | Complete | 2022-04-04 |
| 7. Trust Home | v2.1 | 2/2 | Complete | 2022-04-04 |
| 8. Safety Transparency | v2.1 | 2/2 | Complete | 2022-04-04 |
| 9. Parent Test Mode | v2.1 | 2/2 | Complete | 2022-04-05 |
| 10. Cost Tracking | v2.2 | 2/2 | Complete | 2022-04-05 |
| 11. Admin Chatbot | v2.2 | 2/2 | Complete | 2022-04-05 |
| 12. Prompt Editor | v2.2 | 2/2 | Complete | 2022-04-05 |
| 13. Parent Email Notifications | v2.3 | 3/3 | Complete | 2022-04-05 |
| 14. Enable & Safeguard Image Generation | v2.4 | 1/1 | Complete | 2022-04-10 |
| 15. Safety Alert Extension & Rate Limiting | v2.4 | 5/6 | Complete (bonus superseded) | 2022-04-10 |
| 15.2. Synthetic Message Rendering | v2.4 | 1/1 | Superseded by 15.3 | 2022-04-11 |
| 15.3. Simplification — Remove Bonus Flow | v2.4 | 1/1 | Complete | 2022-04-11 |
| 15.4. Cost Cap & Alert Contract Fixes | v2.4 | 1/1 | Complete | 2022-04-11 |
| 16. LibreChat Interface Hardening | v2.5 | 1/1 | Complete | 2022-04-11 |
| 17. Conversation Delete Protection + Icon Fix | v2.6 | 1/1 | Complete | 2022-04-12 |
| 18. Email Alert System | v2.7 | 3/3 | Complete | 2022-04-13 |
| 19. Budget Exhaustion Investigation & Remediation | v2.8 | 4/4 | Complete | 2022-04-18 |
| 20. Image Search — Research + POC | v2.9 | 6/6 | Complete   | 2022-04-20 |
| 21. Image Search — Production rollout | v2.9 | 6/6 | Complete   | 2022-04-21 |

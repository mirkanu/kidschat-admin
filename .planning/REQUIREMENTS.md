...
- [x] **TEST-02**: Chat sandbox shows predefined scenario buttons (jailbreak attempt, inappropriate topic, boundary test)
- [x] **TEST-03**: Chat sandbox visually indicates which safety rule triggered when a test message is blocked/redirected
